...
public class Strategy3 {
	...
	public static void main(String[] args) {
		...
		strategy = new Nov11Strategy();
		context.setStrategy(strategy);
		System.out.println("JD Nov 11 Price is [" + context.calcPrice() + "]");
	...
	public static abstract class FestivalStrategy implements PriceStrategy{
		@Override
		public final double calcPrice(Context context) {
			double sum = 0;
			for (Goods goods : context.getGoodsList()) {
				sum += goods.getPrice();
			}
			if (sum >= getCouponLimit()) {
		...
		public abstract double getCouponLimit();
		public abstract double getFirstCutoff();
	}

	public static class June18Strategy extends FestivalStrategy {
		@Override
	...
	public static class Nov11Strategy extends FestivalStrategy{
		@Override
		public double getCouponLimit() {
			return 400;
		}
